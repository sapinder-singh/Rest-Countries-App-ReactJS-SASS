...
export default function ThemeIcon() {
	return (
		<svg className='header__theme-icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
			<path fill='none' stroke='#000' strokeLinecap='round' strokeLinejoin='round' strokeWidth='32px' 
